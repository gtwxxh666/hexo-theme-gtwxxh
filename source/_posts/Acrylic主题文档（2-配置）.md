...
大部分配置，butterfly文档都有，自行阅读，此处不再赘述

{% link Butterfly 安装文档(三) 主题配置-1,Jerry,https://butterfly.js.org/posts/4aa8abbe/ %}
