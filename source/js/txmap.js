...
function todis() {
  $.ajax({
    ...
    data: {
      key: "SVWBZ-CFEH3-L2U3A-RE6A7-ZT6WH-S7BQX",
      output: "jsonp",
    },
    dataType: "jsonp",
    success: function (res) {
      ...
      function showWelcome() {
        let dist = getDistance(
          120.55323,
          30.6419,
          pLoacation.result.location.lng,
        ...
        if (date.getHours() >= 5 && date.getHours() < 11)
          ...
          timeChange = "<span>三点几啦</span>，饮茶先啦！";
        ...
        )[0].innerHTML = `欢迎来自<span>${pos}</span>的小伙伴，${timeChange}<br>
  ...
  document
    .querySelector(".rightMenu-item:has(.fa-moon)")
